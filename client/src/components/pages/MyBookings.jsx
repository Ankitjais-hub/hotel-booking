...
const MyBookings = () => {
  ...
  return (
    <div className='py-28 md:pb-35 md:pt-32 px-4 md:px-16 lg:px-24 xl:px-32'>
        ...
        <Title title="My Bookings" subtitle="Easily manage your past, current and upcoming hotel reservations at one place.
              ...
              w-full border-b border-gray-300 py-6 first:border-t'>
                ...
                <div className='flex flex-col md:flex-row'>
                  ...
                  <div className='flex flex-col gap-1.5 max-md:mt-3 min-md:ml-4'>
                    ...
                    <div className='flex items-center gap-1 text-sm text-gray-500'>
                      <img className='h-6 w-6'src={assets.locationIcon} alt="location-icon"/>
                      <span>{booking.hotel.address}</span>
                    </div>
                    <div className='flex items-center gap-1 text-sm text-gray-500'>
                      <img className='h-5 w-5'src={assets.guestsIcon} alt="guests-icon"/>
                ...
                <div className='flex flex-col items-start justify-center pt-3'>
                  <div className='flex items-center gap-2'>
                    ...
                    <div>
                      <p className='font-medium'>{booking.isPaid ? 'Paid' : 'Pending Payment'}</p>
                      <div className='text-sm text-gray-500'>via {booking.paymentMethod}</div>
                    </div>
                    {!booking.isPaid && (
                      <button className='mt-4 px-4 py-1.5 text-xs border border-gray-400 rounded-full
