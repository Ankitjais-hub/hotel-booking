...
const NewsLetter = () => {
  return (
    ...
    <Title title="Stay Inspired" subtitle="Stay updated with the latest news, exclusive offers, and special promotions from QuickStay. Join our community of luxury travelers today!" align="center" />
